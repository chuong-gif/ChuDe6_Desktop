using BusinessLogic; // using tầng BusinessLogic [cite: 4571]
using DataAccess;   // using tầng DataAccess [cite: 4572]
using System;
...
namespace RestaurantManagementProject
{
    ...
    {
         //Danh sách toàn cục bảng Category [cite: 4574]
        List<Category> listCategory = new List<Category>();
         //Danh sách toàn cục bảng Food [cite: 4576]
        List<Food> listFood = new List<Food>();
         //Đối tượng Food đang chọn hiện hành [cite: 4578]
        ...
        {
             //Đổ dữ liệu vào ComboBox [cite: 4585]
        LoadCategory();
         // Đổ dữ liệu vào ListView [cite: 4588]
        ...
        /* Code cho LoadCategory() từ trang 101 */
        ...
        /* Code cho LoadFoodDataToListView() từ trang 101 */
        ...
        /* Code cho lsvFood_Click() từ trang 101 */


          private void cmdClear_Click(object sender, EventArgs e) 
{
     //Gán các ô bằng giá trị mặc định [cite: 4560]
      txtName.Text = ""; 
              txtPrice.Text = "0"; 
              txtUnit.Text = ""; 
              txtNotes.Text = ""; 
            
             // Thiết lập index = 0 cho ComboBox [cite: 4565]
...
public int InsertFood()
{
    ...
    Food food = new Food();
    food.ID = 0; //Vì ID là tự tăng nên giá trị nhận vào được gán mặc định (bằng 0)
    ...
    else
    {
        ...
        try
        {
            price = int.Parse(txtPrice.Text); // Cố gắng lấy giá trị
        }
        catch
        {
            price = 0; // Nếu sai, gán giá = 0
        }
        food.Price = price;
...
/* Code cho InsertFood() từ trang 102 */
...
/* Code cho cmdAdd_Click() từ trang 103 */
...
/* Code cho cmdDelete_Click() từ trang 103 */
...
/* Code cho UpdateFood() từ trang 104 */
...
private void cmdUpdate_Click(object sender, EventArgs e)
{
    ...
    // Nếu thêm không thành công thì thông báo cho người dùng
        ...
        /* Code cho cmdUpdate_Click() từ trang 103 */
    }
}